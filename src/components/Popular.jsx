function Popular({ cars, toggleLike }) {
    return (
        <div className='px-6 pb-9 b-desk:w-[1250px] b-desk:m-auto b-desk:px-0'>
            ...
            <div className='overflow-auto flex gap-3 lg:grid lg:grid-cols-4'>
                {cars.map((car) => (
                    <div key={car.id} className="min-w-[255px] bg-white p-4 rounded-2xl border-2 border-gray-200 lg:min-w-full">
                        ...
                        <div className='max-w-[200px] mx-auto mt-[30px] mb-10 md-desk:max-w-[230px]'>
                        ...
                        <div className='flex items-center gap-4'>
                            <div className='flex items-center gap-1'>
                                ...
                                <p className='text-[13px] text-gray-400 font-semibold'>{car.fuel}</p>
                            </div>
                            <div className='flex items-center gap-1'>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p className='text-[13px] text-gray-400 font-semibold'>{car.transmission}</p>
                            </div>
                            <div className='flex items-center gap-1'>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p className='text-[13px] text-gray-400 font-semibold'>{car.capacity}</p>
                            </div>
                        </div>
