function Car({ car, toggleLike }) {
    return (
        <div className="min-w-[255px] bg-white p-4 rounded-2xl border-2 border-gray-200 lg:min-w-full">
            ...
            {/* Image */}
            <div className='max-w-[200px] mx-auto mt-[30px] mb-10 md-desk:max-w-[230px] relative'>
