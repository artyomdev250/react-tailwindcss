function RecommendationCar({ car, toggleLike }) {
    return (
        <div className='bg-white p-4 rounded-2xl border-2 border-gray-200'>
            ...
            <div className='flex items-start justify-between mb-4'>
                <div>
                    ...
                    <p className='text-gray-400 text-[15px] font-medium'>{car.type}</p>
                </div>

                {/* Like Button */}
                <button className='cursor-pointer' onClick={() => toggleLike(car.id)}>
                    {car.liked ? (
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="#ED3F3F">
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M16.44 3.09961C14.63 3.09961 13.01 3.97961 12 5.32961C10.99 3.97961 9.37 3.09961 7.56 3.09961C4.49 3.09961 2 5.59961 2 8.68961C2 9.87961 2.19 10.9796 2.52 11.9996C4.1 16.9996 8.97 19.9896 11.38 20.8096C11.72 20.9296 12.28 20.9296 12.62 20.8096C15.03 19.9896 19.9 16.9996 21.48 11.9996C21.81 10.9796 22 9.87961 22 8.68961C22 5.59961 19.51 3.09961 16.44 3.09961Z" stroke="#ED3F3F" strokeWidth="2" />
                        </svg>
                    )}
                </button>
            </div>

            <div className="flex items-center gap-6 justify-center lg:flex-col lg:items-start">

                {/* Image */}
                <div className="flex justify-center lg:max-w-[230px] lg:mx-auto relative">
                    <img src={car.image} alt="car" className='w-[90%] lg:w-full' />
                    <div className="absolute w-full h-[50%] bottom-[0%] bg-linear-to-t from-white to-transparent" />
                </div>
                ...
                <div className='flex flex-col gap-3 lg:flex-row lg:gap-3.5'>
                    <div className='flex items-center gap-1'>
                        ...
                        <p className='text-[13px] text-gray-400 font-medium'>{car.fuel}</p>
                    </div>
                    <div className='flex items-center gap-1'>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className='text-[13px] text-gray-400 font-medium'>{car.transmission}</p>
                    </div>
                    <div className='flex items-center gap-1'>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className='text-[13px] text-gray-400 font-medium'>{car.capacity}</p>
                    </div>
                </div>
            </div>

            {/* Footer */}
            <div className='flex items-center justify-between mt-9 gap-2.5 lg:mt-5'>
                <p className='text-[14.5px] font-semibold'>
                    ${car.price}.00/ <span className='text-gray-400'>day</span>
                </p>
                <button className='cursor-pointer shadow-2xl shadow-gray-300 text-[14.5px] outline-0 text-white bg-blue-600 font-semibold py-2.5 px-3 rounded-[7.5px]'>
                    Rental Now
                </button>
            </div>
        </div>
