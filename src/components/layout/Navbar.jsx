        ...
        <div className='p-6 bg-white lg:border-b-2 border-gray-200'>
            <div className='flex flex-col gap-[25px] lg:flex-row lg:items-center b-desk:w-[1250px] b-desk:m-auto'>
                ...
                <div className='flex items-center justify-between gap-4 lg:gap-2.5'>
                    <div className='flex items-center gap-2.5 w-full text-[14px] font-medium px-5 py-3 border-2 border-gray-200 rounded-2xl lg:py-2.5 lg:px-4 lg:rounded-4xl'>
                    ...
                    <button className='flex p-3 cursor-pointer border-2 border-gray-200 rounded-2xl lg:p-2.5'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='ml-auto hidden items-center gap-[15px] lg:flex'>
                    ...
                    <img src="/ava.jpg" alt="avatar" className='w-11 rounded-full' />
                </div>
            </div>
        </div>
    )
