        ...
        <div className='p-[24px] bg-white lg:border-b-2 border-gray-200'>
            <div className='flex flex-col gap-[25px] lg:flex-row lg:items-center b-desk:w-[1250px] b-desk:m-auto'>
                <div className='flex items-center justify-between'>
                    <p className='text-[24px] font-bold text-blue-600'>MORENT</p>
                    <img src="/ava.jpg" alt="avatar" className='w-[35px] rounded-full lg:hidden' />
                </div>
                <div className='flex items-center justify-between gap-[16px] lg:gap-[10px]'>
                    <div className='flex items-center gap-[10px] w-full text-[14px] font-medium px-[20px] py-[12px] border-2 border-gray-200 rounded-2xl lg:py-[10px] lg:px-[16px] lg:rounded-4xl'>
                ...
                <div className='ml-auto hidden items-center gap-[15px] lg:flex'>
                    <button className='rounded-full p-[8px] border-2 border-gray-200'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className='rounded-full p-[8px] border-2 border-gray-200 relative'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='absolute w-[11px] h-[11px] rounded-full bg-orange-600 top-0 right-0' />
                    </button>
                    <button className='rounded-full p-[8px] border-2 border-gray-200'>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <img src="/ava.jpg" alt="avatar" className='w-[44px] rounded-full' />
                </div>
            </div>
        </div>
    )
